            ...
            <div class="text-area">
                ...
                <div>
                    <div>
                        ...
                        <p>{{ generateNickname(boardRefData.post_id, boardRefData.user_id) }}</p>
                        <button>
                    ...
                    <div>
                        <p>{{ boardRefData.category }} · {{ formatDate(boardRefData.created_at) }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <button @click="onClickLikeBtn()">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                            ...
                            <path :fill="isLiked ? 'url(#gradient1)' : '#000000'"
                                d="M720-120H280v-520l280-280 50 50q7 7 11.5 19t4.5 23v14l-44 174h258q32 0 56 24t24 56v80q0 7-2 15t-4 15L794-168q-9 20-30 34t-44 14Zm-360-80h360l120-280v-80H480l54-220-174 174v406Zm0-406v406-406Zm-80-34v80H160v360h120v80H80v-520h200Z" />
                        </svg>
                    </div>
                    <p :class="isLiked ? 'gradient-font' : ''">{{ formatNumber(likesCount) }}</p>
                </button>
            </div>
        </div>
        <div class="comment-area" v-if="commentRefData.length > 0">
            ...
            <div class="content-area">
                <div v-for="(item, index) in commentRefData" :key="index">
                    <svg v-if="item.parent_comment_id !== null" xmlns="http://www.w3.org/2000/svg" height="24px"
                    ...
                    <div class="info-area">
                        <div class="top-area">
                            ...
                            <div>
                                <p>{{ formatDate(boardRefData.created_at) }}</p>
                                <button>...</button>
                            </div>
                        </div>
                        ...
                        <div class="bottom-area">
                            <button class="reply-btn" v-if="item.parent_comment_id === null">대댓글</button>
...
const fetchData = async () => {
    try {
        ...
        commentRefData.value = commentData;
